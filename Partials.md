...
This will wrap the partial with the code found in `views/boxes/_blue.cfm`. Just like with other layouts, you use [includeContent()](includeContent.md) to represent the partial's content.
